...
public class Main {
    public static void main(String[] args) {
        Animalble Sheep = new Elephant("Manea",4, 39, 501, 2, "WHITE");
        Animalble Goat = new Elephant("Marusea",1, 39, 499, 2, "BLACK");
        Erbivor Cow = new Elephant("Bureonka", 4, 30, 300,2, "RED");
        Erbivor Crocodile = new Elephant("Gena", 4, 150,200,2, "GREEN");
